...
setuptools.setup(
    ...
    url='https://github.com/klmitch/humboldt/tree/master/tools/state_analyzer',
    description='Humboldt State Analyzer',
    ...
    entry_points={
        'console_scripts': [
            'humstate-canon = state_analyzer.main:canon.console',
            'humstate-dot = state_analyzer.main:dot.console',
        ],
    },
)
